...
Build command: echo "window.SUPABASE_URL = '${SUPABASE_URL}'; window.SUPABASE_KEY = '${SUPABASE_KEY}';" > config/config.local.js
...
- El directorio publicado será `frontend/`
- Index será servido desde `frontend/index.html`
